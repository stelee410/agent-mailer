...
def render_team_yaml(team: str, broker_url: str, permission_mode: str, runtime: str = "claude") -> str:
...
def create_default_team(
    *,
    ...
    (out_dir / "team.yaml").write_text(render_team_yaml(team, broker_url, permission_mode, runtime))
